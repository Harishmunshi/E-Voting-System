...
export function SuccessCountdown() {
  ...
  return (
    <Card className="mx-auto max-w-lg p-8 text-center">
      ...
      <h2 className="mt-6 text-3xl font-bold text-[#1A1A1A]">Your vote has been successfully recorded.</h2>
      ...
      <div className="mt-6 rounded-2xl border border-gold-600/40 bg-[#F8F7F4] px-4 py-4 text-maroon-900">
